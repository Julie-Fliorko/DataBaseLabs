...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `julie_fliorko_db`.`country` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `julie_fliorko_db`.`production_company` (
                                                                       `id` INT NOT NULL AUTO_INCREMENT,
                                                                       `name` VARCHAR(45) NOT NULL,
                                                                       `founded` YEAR NULL DEFAULT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `julie_fliorko_db`.`film` (
                                                         `id` INT NOT NULL AUTO_INCREMENT,
                                                         `name` VARCHAR(45) NOT NULL,
                                                         ...
                                                         CONSTRAINT `fk_film_country1`
                                                             FOREIGN KEY (`country_id`)
                                                                 REFERENCES `julie_fliorko_db`.`country` (`id`),
                                                         CONSTRAINT `fk_film_production_company1`
                                                             FOREIGN KEY (`production_company_id`)
                                                                 REFERENCES `julie_fliorko_db`.`production_company` (`id`))
    ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `julie_fliorko_db`.`fun_fact` (
                                                             `id` INT NOT NULL AUTO_INCREMENT,
                                                             ...
                                                             CONSTRAINT `fk_fun_fact_film1`
                                                                 FOREIGN KEY (`film_id`)
                                                                     REFERENCES `julie_fliorko_db`.`film` (`id`))
    ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `julie_fliorko_db`.`review` (
                                                           `id` INT NOT NULL AUTO_INCREMENT,
